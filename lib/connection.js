 ...
 *  credsUpdate?: () => void 
 * }} EventHandlers
 * @typedef {Required<import('baileys').UserFacingSocketConfig>['logger']} Logger
 ...
 *  isChild?: boolean; 
 *  connectionOptions?: Partial<import('baileys').UserFacingSocketConfig>; 
 *  store: typeof store 
 * }} opts
 */
...
/**
 * @this {Socket}
 * @param {import('baileys').BaileysEventMap<unknown>['connection.update']} update
 */
